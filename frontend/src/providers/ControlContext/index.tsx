...
interface ControlContextState {
  selectedModel: "gemini-pro" | "senso-vision";
  ...
  handleModelChange: (model: "gemini-pro" | "senso-vision") => void;
...
export const ControlProvider = ({ children }: { children: ReactNode }) => {
  ...
  const handleModelChange = (model: "gemini-pro" | "senso-vision") => {
